...
public class Waypoint : MonoBehaviour
{
	...
	void Update()
	{
		...
		//bool occupied = Camera.main.transform.position == new Vector3 (gameObject.transform.position.x, 2f, gameObject.transform.position.z); ;
	...
	public void Click()
	{
		...
		//Camera.main.transform.position 	= new Vector3 (gameObject.transform.position.x, 2f, gameObject.transform.position.z);;
